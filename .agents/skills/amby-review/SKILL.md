...
---
<!-- GENERATED by AmbyKit from src/prompts/review.md — do not edit by hand; run `ambykit sync`. -->

Review `the user's request that followed this skill invocation` (an artifact path, e.g. `specs/NNN-slug/spec.md`) as a **different** role.
